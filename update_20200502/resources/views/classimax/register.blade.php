    ...
    <div class="container">
        <form method="POST" action="{{ route('register') }}">
            ...
            <label class="has-float-label">
              <input class="form-control" type="text" name="name" placeholder="John Saraga"/>
            ...
            <label class="has-float-label">
              <input class="form-control" type="email" name="email" placeholder="example@saraga.id"/>
            ...
            <input name="telephone" type="number" placeholder="08XXXXXXXXXX" class="border form-control mt-4">
