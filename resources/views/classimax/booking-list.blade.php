								...
								<div class="row p-3">
									<div class="card" style="width: 100%; cursor:pointer;"onclick="window.location.href='http://localhost/sportscenter/booking/detail'">
										@if(isset($booking->token))
									  	...
									  	@endif
									    	<img class="card-img-top" src="{{$booking->detail[0]->image->path}}" alt="Card image cap" style="max-height: 35rem">
									  	</a>
										...
										<div class="card-body">
										    <h5 class="card-title text-truncate pt-3" style="margin-top:-50px;">{{$booking->detail[0]->spot->name}}</h5>
										    <span class="badge badge-pill badge-success p-2" style="background-color: rgb(233, 255, 236); border: 1px solid green; color: black;">{{$booking->detail[0]->sport->slug}}</span>
